...
const SingleProduct = forwardRef<HTMLElement, SingleProductProps>(
  (props, ref) => {
    ...
    // Add null check before getting variants
    const adjacentVariants = product ? getAdjacentAndFirstAvailableVariants(product) : null;
    ...
    // Get the product options array only if product exists
    const productOptions = product ? getProductOptions({
      ...product,
